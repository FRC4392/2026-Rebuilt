...
public class ClimberIOReal implements ClimberIO {
    ...
    public ClimberIOReal(){
      ...
      new TalonFXConfiguration()
        ...
        BaseStatusSignal.setUpdateFrequencyForAll(50.0, climberPosition, climberVelocity, climberVoltage, climberCurrent, climberTemperatre);
    ...
    public void updateInputs(ClimberIOInputs inputs) {
        var motorStatus = BaseStatusSignal.refreshAll(climberPosition, climberVelocity, climberVoltage, climberCurrent, climberTemperatre);
