...
public class IntakeIOReal implements IntakeIO {
  ...
  public IntakeIOReal() {
    ...
    BaseStatusSignal.setUpdateFrequencyForAll(
        50.0, intakePosition, intakeVelocity, intakeVoltage, intakeCurrent, intakeTemperature);
  ...
  public void updateInputs(IntakeIOInputs inputs) {
    var motorStatus =
        BaseStatusSignal.refreshAll(
            intakePosition, intakeVelocity, intakeVoltage, intakeCurrent, intakeTemperature);
