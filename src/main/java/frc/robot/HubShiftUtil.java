...
public class HubShiftUtil {
  ...
  private static final double minTimeOfFlight = 2.0;
  private static final double maxTimeOfFlight = 5.0;
  ...
  public static ShiftInfo getOfficialShiftInfo() {
    ShiftInfo officialInfo = getShiftInfo(getSchedule(), shiftStartTimes, shiftEndTimes);
    Logger.recordOutput("Shift Info/Official Shift Info", officialInfo);
    return officialInfo;
  }
  ...
  public static ShiftInfo getShiftedShiftInfo() {
    ...
    if (shiftSchedule[1] == true) {
      ...
      ShiftInfo shiftedShiftInfo =
          getShiftInfo(shiftSchedule, shiftedShiftStartTimes, shiftedShiftEndTimes);
      Logger.recordOutput("Shift Info/Shifted Shift Info", shiftedShiftInfo);
      return shiftedShiftInfo;
    }
    double[] shiftedShiftStartTimes = {
      0.0,
